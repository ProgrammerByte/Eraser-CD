    ...
    while (lc->link[j] != -1) {
      ...
      if (theLast - theFirst == node[j] && k_length - theFirst == j_len) {
        ...
        ScatterSuperUpdate(lc->storage, theLast - theFirst, k_length - theFirst,
                           (double *)&LB.entry[LB.col[j]].nz, j_len, relative);
      } else {
        FindRelativeIndicesLeft(&LB.row[LB.col[k] + theFirst],
                                k_length - theFirst, 0, indices, relative);
...
void ModifySuperBySuper(long src, long theFirst, long theLast, long length,
  ...
  while (last < lastcol) {
    ...
    i = theFirst;
    for (; i < theLast - 1; i += 2) {
      ModifyTwoBySupernodeB(first, last, i - (first - src), destination,
...
void ModifyTwoBySupernodeB(long super, long lastcol, long theFirst,
  ...
  while (col < lastcol - 7) {
    ...
    *dest0++ -= ljk0_0 * ljk0_0 + ljk1_0 * ljk1_0 + ljk2_0 * ljk2_0 +
                ljk3_0 * ljk3_0 + ljk4_0 * ljk4_0 + ljk5_0 * ljk5_0 +
                ljk6_0 * ljk6_0 + ljk7_0 * ljk7_0;
    *dest1++ -= ljk0_1 * ljk0_1 + ljk1_1 * ljk1_1 + ljk2_1 * ljk2_1 +
                ljk3_1 * ljk3_1 + ljk4_1 * ljk4_1 + ljk5_1 * ljk5_1 +
                ljk6_1 * ljk6_1 + ljk7_1 * ljk7_1;

    *dest0++ -= ljk0_0 * ljk0_1 + ljk1_0 * ljk1_1 + ljk2_0 * ljk2_1 +
                ljk3_0 * ljk3_1 + ljk4_0 * ljk4_1 + ljk5_0 * ljk5_1 +
                ljk6_0 * ljk6_1 + ljk7_0 * ljk7_1;
  ...
  while (col < lastcol - 3) {
    ...
    *dest0++ -=
        ljk0_0 * ljk0_0 + ljk1_0 * ljk1_0 + ljk2_0 * ljk2_0 + ljk3_0 * ljk3_0;
    *dest1++ -=
        ljk0_1 * ljk0_1 + ljk1_1 * ljk1_1 + ljk2_1 * ljk2_1 + ljk3_1 * ljk3_1;

    *dest0++ -=
        ljk0_0 * ljk0_1 + ljk1_0 * ljk1_1 + ljk2_0 * ljk2_1 + ljk3_0 * ljk3_1;
